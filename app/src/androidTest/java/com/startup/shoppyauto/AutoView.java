...
public class AutoView {
    ...
    public void autoView() {
        ...
        try {
            switch (step) {
                case 0:
                    UiObject2 btnSearch = mDevice.findObject(By.text("đầm nữ"));
                    if (btnSearch != null) {
                        btnSearch.click();
                        step = 1;
                    }
    ...
    public void searchProduct() {
        ...
        if (edtSearch!=null){
            ...
            mDevice.pressKeyCode('0');
            mDevice.pressKeyCode('5');
            mDevice.pressKeyCode('6');
            sleep();
        }
        UiObject2  btnSubmit = null;
        /* btnSubmit = mDevice.findObject(By.res("com.google.android.inputmethod.latin:id/key_pos_ime_action"));
        ...
        if(btnSubmit==null){
            Log.d("keyboard", "click search");
          //  mDevice.pressKeyCode(84);
        }
    ...
    public void oppenAppActivity() {
        ...
        final Intent intent = context.getPackageManager()
               ...
               // .getLaunchIntentForPackage("com.android.chrome");
                .getLaunchIntentForPackage("com.shopee.vn");
        if (intent == null) {
            oppenMainActivity("Không có app fb");
            return;
        }
